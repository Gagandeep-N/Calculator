...
b0 = Button(root,text="0",padx=41,pady=20,command=lambda: button_click(0))
b_clr = Button(root,text="clear",padx=31,pady=20,command= button_clear)
b_equal = Button(root,text="=",padx=39,pady=20,command=button_equal)

b_add = Button(root,text="+",padx=40,pady=20,command= button_add)
b_sub = Button(root,text="-",padx=41,pady=20,command=button_subtract)
b_mul = Button(root,text="* ",padx=41,pady=20,command=button_multiply)
